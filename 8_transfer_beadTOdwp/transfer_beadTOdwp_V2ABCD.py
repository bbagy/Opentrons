def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samp":96,"vol_dispensed":500,"delay":0,"asp_height":12,"disp_height":2,"asp_speed":1,"disp_speed":1,"p300_mount":"right"}""")
...
def run(ctx):
    ...
    for samp, dest in zip(tubes, plate.wells()):
        ...
        while vol_remaining > 0:
            vol = min(vol_remaining, 250)  # Limiting the volume to 200µl
