        ...
        with open(source_file, 'r') as file:
            ...
            # Process DNA volume
                try:
                    ...
                    print(f"Invalid or empty DNA volume in row: {row}. Ignoring this value.")
                    dna_vol = 0  # or you can set a default value here
            ...
            # Process Water volume
                try:
                    if water_vol != '':
                        ...
                        print(f"Empty Water volume in row: {row}. Ignoring this row.")
                except ValueError as e:
                    print(f"Invalid Water volume in row: {row}. Ignoring this row.")
