def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samp":8,"plate_A_start_col":1,"plate_B_start_col":1,"plate_C_start_col":1,"tip_park_start_col":1,"asp_height":1,"length_from_side":1.5,"m20_mount":"left","m300_mount":"right"}""")
