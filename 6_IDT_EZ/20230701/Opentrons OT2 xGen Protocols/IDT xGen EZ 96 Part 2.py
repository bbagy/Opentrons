...
def run(protocol: protocol_api.ProtocolContext):
    ...
    barcode_plate       = temp_block.load_labware('opentrons_96_aluminumblock_biorad_wellplate_200ul')
    ...
    tiprack_200_4       = protocol.load_labware('opentrons_96_filtertiprack_200ul', '10')
