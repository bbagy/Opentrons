def get_values(*names):
    ...
    "number_of_samples":48,"mix_TWB":true,"reagent_plate_bottom":-1.6,
...
metadata = {
    'protocolName': 'Illumina DNA prep kit before indexing(48)',
    ...
    on magnet for ' + str(mag_inc_min) + ' minutes.')
            ...
            for set_ind, (sample_set, parking_set, waste_set) in enumerate(
                ...
                for dist_set in dist_sets:
                    ...
                    for m in dist_set:
                        m300.aspirate(vol_EPM, source.bottom(-0.5))
                        m300.air_gap(3)
